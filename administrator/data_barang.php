...
<div class="card container" style="margin-top: 120px;">
	<div class="card-body">
		...
		<a href="brg.php" target="brg.php" type="button" class="btn btn-success btn-sm">
		  ...
		  <table id="hanifah" class="table align-middle table cell-border table-hover">
			...
			<tbody>
				...
				while($d = mysqli_fetch_array($data)){
					...
					<!-- Modal Edit Data-->
					<div class="modal fade"style="margin-top: 100px;" id="edit-data<?php echo $d['ProdukID']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
					...
					<!-- Modal Hapus Data-->
					<div class="modal fade"style="margin-top: 70px;"  id="hapus-data<?php echo $d['ProdukID']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
