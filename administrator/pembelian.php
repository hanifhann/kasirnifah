...
<div class="card container" style="margin-top: 120px;">
	<div class="card-body">
		...
		<a href="beli.php" target="beli.php" type="button" class="btn btn-success btn-sm" >
		 ...
		 <table id="hanifah" class="table align-middle table cell-border table-hover">
			...
			<tbody>
				...
				while($d = mysqli_fetch_array($data)){
					...
					<!-- Modal Edit Data-->
					<div class="modal fade" id="edit-data<?php echo $d['PelangganID']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="margin-top: 70px;">
					...
					<!-- Modal Hapus Data-->
					<div class="modal fade" id="hapus-data<?php echo $d['PelangganID']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="margin-top: 70px;">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
...
<!-- Modal Tambah Data-->
<div class="modal fade" id="tambah-data" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="margin-top: 70px;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Data</h1>
